...
exp_name=${EXP_NAME:-stage2_1024_${MODEL}_${VAE_TYPE}vae_nisp_${NISP_MODE}_scale${NISP_SCALE_MIN}-${NISP_SCALE_MAX}_${NISP_HEAD_TYPE}${NISP_HEAD_HIDDEN_DIM}_w${NISP_WEIGHT}}
