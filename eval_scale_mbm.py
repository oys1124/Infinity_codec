...
from compression.sender_mbmv2 import encoding
from compression.reciever_mbmv2 import decompress_cfg, decoding
...
if __name__ == "__main__":
    ...
    initial_model_path='/workspace/Infinity_codec/local_output/debug_stage2_2026_5_06_mbm_v2_small_3090/slim-checkpoint/slim-ckpt-giter015K-ep0-iter15000-last.pth'
    ...
    for current_filename in models_to_test:
        ...
        args.rec_path = f'/workspace/Infinity_codec/results/debug_stage2_2026_5_06_mbm_v2_small_3090_step4_15k_bernoulli_sample/DIV2K_dynamic_{current_iter}'
